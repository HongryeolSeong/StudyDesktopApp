...
namespace StudyHistoryApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            hanover.Nodes.Add("GRG5", "조지 5세(1830~1837)");
            hanover.Nodes.Add("GRG6", "조지 6세(1837~1901)");
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Name == "ANN1")
            {
                ...
                TxtDescription.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드, " +
                    ...
                    "ut repudiandae deleniti laborum nemo veniam optio quisquam earum aperiam esse soluta eligendi unde dolore impedit.";
            }
            else if (e.Node.Name == "GRG1")
            {
                PcbPhoto.Image = Bitmap.FromFile("./images/King_George_I.jpg");
                TxtDescription.Text = "잉글랜드 의회에서 1701년 왕위결정법이 통과되면서, " +
                    "Lorem ipsum dolor sit amet consectetur adipisicing elit. " +
                    "Consequatur qui eum rem assumenda quia, " +
                    "ut repudiandae deleniti laborum nemo veniam optio quisquam earum aperiam esse soluta eligendi unde dolore impedit.";
            }
