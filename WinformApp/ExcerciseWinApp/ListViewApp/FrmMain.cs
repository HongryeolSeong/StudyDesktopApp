...
namespace ListViewApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            ListViewItem itemPs = new ListViewItem("Playstion 4", 2);
        ...
        {
            if (RdbSmallIcon.Checked) LsvProduct.View = View.SmallIcon;
        }

        private void RdbBigIcon_CheckedChanged(object sender, EventArgs e)
        {
            if (RdbBigIcon.Checked) LsvProduct.View = View.LargeIcon;
        }
